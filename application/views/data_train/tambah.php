							...
							<div class="row">
								...
								<div class="col-lg-6 mb-2">
									...
									<div class="input-group mb-3">
										...
										<input class="form-control" type="month" name="bulan" placeholder="Bulan" />
									</div>
								...
								<div class="col-lg-6 mb-2">
									...
									<div class="input-group mb-3">
										<input class="form-control" type="text" name="wilayah" min="0" placeholder="Masukkan Wilayah" />
									</div>
								...
								<div class="col-lg-6 mb-2">
									...
									<div class="input-group mb-3">
										<input class="form-control" type="number" name="curah_hujan" min="0" placeholder="Curah Hujan" />
								...
								<div class="col-lg-6 mb-2">
									<h6 for="hama">Hama</h6>
									<div class="input-group mb-3">
										<input class="form-control" type="text" name="hama" min="0" placeholder="Jenis Hama" />
									</div>
